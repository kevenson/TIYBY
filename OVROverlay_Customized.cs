...
namespace OculusSampleFramework
{
    ...
    /// 
    /// </summary>
    public class OVROverlay_Customized : MonoBehaviour
    {
        ...
        void Start()
        {
            DebugUIBuilder.instance.AddLabel("VR Calibration");
            DebugUIBuilder.instance.AddDivider();
            DebugUIBuilder.instance.AddLabel("Please put your headset on");
            DebugUIBuilder.instance.AddButton("Calibrate VR Setup", CalibrateVR);
            DebugUIBuilder.instance.AddButton("Save calibration and start game", SaveAndContinue);
            //DebugUIBuilder.instance.AddDivider();
        ...
        // Custom VR Height Calibration
        void CalibrateVR()
        {
            return;
        }

        // save calibration data and continue
